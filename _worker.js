...
let userID = 'b7cc1bba-2b80-4d5d-aa36-fc1c3f5a151d';
...
const generateRemark = (index, port) => {
    ...
    switch (index) {
        case 0:
        case 1:
            remark = `Faroqh_${index + 1} : ${port}`;
            break;
        case 2:
        case 3:
            remark = `Faroqh_IPv4_${index - 1} : ${port}`;
            break;
        case 4:
        case 5:
            remark = `Faroqh_IPv6_${index - 3} : ${port}`;
            break;
        default:
            remark = `Faroqh_Clean IP_${index - 5} : ${port}`;
            break;
    }
...
const buildWorkerLessConfig = async (env, client) => {
    ...
    fragConfig.remarks  = 'Faroqh_ WorkerLess ⭐'
...
const getFragmentConfigs = async (env, hostName, client) => {
    ...
    bestPing.remarks = 'Faroqh_ Best Ping 💥';
    ...
    bestFragment.remarks = 'Faroqh_Best Fragment 😎';
...
const getWarpConfigs = async (env, client) => {
    ...
    xrayWarpBestPing.remarks = 'Faroqh_Warp Best Ping 🚀'
    ...
    xrayWoWOutbounds.forEach((outbound, index) => {
        if (outbound.tag.includes('warp-out')) {
            ...
            xrayWoWConfig.remarks = `Faroqh_ WoW ${index/2 + 1} 🌍`;
